import type { ExpertiseFormData } from "@/types/expertise";
...
} from "@/app/actions/expertise";

export default async function EditExpertisePage(props: {
  ...
  const handleUpdate = async (data: ExpertiseFormData) => {
    "use server";
