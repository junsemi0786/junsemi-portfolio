...
export default function AdminMainPageForm({
  initialData,
  onSubmit,
}: AdminMainPageFormProps) {
  const [formData, setFormData] = useState<MainPageData>(initialData);
  const [loading, setLoading] = useState(false);

  const handleChange = (
    section: keyof MainPageData,
    field: string,
    value: string,
  ) => {
    setFormData((prev) => ({
        ...
        >
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("hero", "titleLine1", e.target.value)
              }
              style={inputStyle}
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                handleChange("hero", "titleLine2", e.target.value)
              }
              style={inputStyle}
            />
          </div>
