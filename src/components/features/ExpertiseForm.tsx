...
export default function ExpertiseForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        isEditing ? "수정 완료되었습니다." : "등록 완료되었습니다.",
        { id: toastId },
      );
    } catch (error) {
  ...
  return (
    ...
    >
      <div className="form-group" style={{ marginBottom: "1.5rem" }}>
        ...
        >
          ID (고유 식별자, 영문 소문자/숫자/하이픈 권장, 띄어쓰기 금지) *
        </label>
        <input
          type="text"
          name="id"
